...
--
-- Host: mysql-lorenzodellamatera.mysql.database.azure.com    Database: ledlamps
-- ------------------------------------------------------
...
CREATE TABLE `lamps` (
  ...
  `host` varchar(60) DEFAULT 'lorenzodellamatera.northeurope.cloudapp.azure.com',
  PRIMARY KEY (`idLamp`),
  KEY `opMode` (`opMode`),
...
INSERT INTO `lamps` VALUES ('08cd923367890009657eab812753379bdb321eeb','#ff0000','#00ff00','#0000ff',9,0,255,'','',0,'lorenzodellamatera.northeurope.cloudapp.azure.com'),('b2ccc8fead1234b2aa40c8cfde3b0033a01b64a8','#ff0000','#00ff00','#0000ff',41,0,255,'','',0,'80.211.47.247');
...
-- Dump completed on 2023-01-04 21:10:24
